...
values."
  (setq-default
   ...
   dotspacemacs-configuration-layer-path '("~/.spacemacs.local/")
...
in `dotspacemacs/user-config'."
  ;; Make sure GOROOT is set
  (setenv "GOROOT" "/usr/local/go")
  ;; Add Cabal's bin directory to PATH
...
layers configuration. You are free to put any user code."
  ...
  (global-set-key [s-down] 'View-scroll-line-backward)  ;; requires the view library

  ;; Override git author/committer email addresses for Spirent
  (setenv "GIT_AUTHOR_EMAIL" "lee.wheat@spirent.com")
  (setenv "GIT_COMMITTER_EMAIL" "lee.wheat@spirent.com")

  ;; Use goimports instead of gofmt
  (setq gofmt-command (expand-file-name "~/work/go/bin/goimports"))
